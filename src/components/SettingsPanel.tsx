      ...
      <section className="settings-modal" role="dialog" aria-modal="true" aria-labelledby="settings-title">
        ...
        <div className="settings-scroll">
          <section className="setting-section" aria-labelledby="account-title">
            <div className="setting-section-title"><span className="setting-icon"><Icon name="cloud" /></span><div><h3 id="account-title">기기 간 계정 동기화</h3><p>AI 도구·모델, 토큰·비용·사용 시각, 익명 프로젝트·세션·기기 ID, 표시용 이름과 기기 OS·앱 버전·최근 연결 시각을 같은 계정에서 합칩니다.</p></div></div>
