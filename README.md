...
- 설정에서 OpenAI Codex·Claude·Gemini를 선택하고 활성 서비스의 사용량·잔여 한도만 수집·동기화.
...
Windows 설치 파일은 `src-tauri/target/release/bundle/nsis/Token Deck_0.5.2_x64-setup.exe`에 생성됩니다.
